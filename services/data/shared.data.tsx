...
export const testimonialsData = [
  {
    id: 1,
    message:
      "Lemon Jelly Media saved my trip to Japan! Instant activation, perfect coverage, and no hidden fees. Never going back to physical SIMs.",
  ...
  },
  {
    id: 2,
    message:
      "Switched 8 employees to Lemon Jelly Media for business trips. The dashboard makes managing data plans across time zones effortless.",
